...
<div id="mailto-window">
	...
	<div class="mailto-close">
		<div style="margin-bottom: 10px;"><a href="javascript: void window.close()" title="<?php echo JText::_('COM_MAILTO_CLOSE_WINDOW'); ?>">
		 <?php echo JText::_('COM_MAILTO_CLOSE_WINDOW'); ?></a></div>
	</div>
